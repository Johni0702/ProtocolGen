Reads the json protocol info (currently from [here](https://github.com/PrismarineJS/minecraft-data/blob/master/data/1.9/protocol.json)) and turns it into java source files.

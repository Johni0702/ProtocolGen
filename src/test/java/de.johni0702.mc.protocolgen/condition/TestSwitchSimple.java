...
import de.johni0702.mc.protocolgen.test.PacketTestSwitchSimple;
...
public class TestSwitchSimple extends PacketReadWriteTest {
    private PacketTestSwitchSimple packet;

    @Before
    public void init() {
        packet = new PacketTestSwitchSimple();
    }
